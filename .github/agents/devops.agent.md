---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-accounting, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-accounting`.
...
- Checkout local: `app-community/modules/controleonline/ui-accounting`
